    ...
    <div class="w-full max-w-md">
      ...
      <div class="text-center mb-8">
        <div class="inline-flex items-center gap-2 mb-4">
          ...
          <h1 class="text-2xl font-black tracking-tighter bg-gradient-to-r from-white to-slate-400 bg-clip-text text-transparent">
            CINEPULSE
          </h1>
        </div>
      ...
      <div class="bg-slate-900 border border-white/10 rounded-2xl p-8 shadow-2xl">
        ...
        <div class="flex items-center gap-3 mb-6">
          ...
          <span class="text-slate-500 text-xs">或使用 Email</span>
          <div class="flex-1 h-px bg-white/10"></div>
        </div>
        ...
        <form @submit.prevent="handleEmailSubmit" class="space-y-4">
          <div>
            ...
            <input
              ...
              class="w-full bg-slate-800 border border-white/10 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500/50 transition-all"
            />
          </div>
          <div>
          ...
          <button
            ...
            class="w-full bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed font-semibold py-3 rounded-xl transition-colors"
          >
            {{ isSubmitting ? '處理中...' : (isRegisterMode ? '建立帳號' : '登入') }}
          </button>
        </form>
        ...
        <p class="text-center text-sm text-slate-500 mt-6">
          ...
          <button
            ...
            class="text-indigo-400 hover:text-indigo-300 transition-colors ml-1"
          >
